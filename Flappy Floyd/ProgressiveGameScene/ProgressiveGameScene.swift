...
class ProgressiveGameScene: SKScene, SKPhysicsContactDelegate, GADInterstitialDelegate, GKGameCenterControllerDelegate {
    ...
    var level: Int = UserDefaults.standard.integer(forKey: "chosenLevel")
    var blockNumber: Int = UserDefaults.standard.integer(forKey: "chosenLevel")
    var score: Int = 0
    ...
    var background = SKSpriteNode(imageNamed: "level\(UserDefaults.standard.integer(forKey: "chosenLevel"))")
        ...
        if isDied {
            for touch in touches {
                ...
                if restartBtn.contains(location){
                    level = UserDefaults.standard.integer(forKey: "chosenLevel")
                    levelGoal = 0
    ...
    func changeLevel()  {
        ...
        userDefaults.set(1, forKey: "level\(level)Complete")
